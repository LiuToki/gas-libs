var GASLibLoadVisaFileBundle = (function (exports) {
    'use strict';
     ...
     */
    function callbackVisaAux_(formObject, colNum, colDate, colName, colAmount, colRemarks, colCard, colOne) {
        // 同じカラム番号は入れちゃダメ.
        // 適当過ぎてちょっとアレなコード.
        var isError = false;
    ...
    exports.callbackVisa = callbackVisa;
    exports.visa = visa;
